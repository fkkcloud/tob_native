...
BasicGame.Preload.prototype = {
	...
	this.load.bitmapFont('flappyfont', 'assets/fonts/flappyfont/flappyfont.png', 'assets/fonts/flappyfont/flappyfont.fnt');  
        ...
        // splash logo load
        this.load.image("kingsl_splash", "assets/kingsl_splash.png");

        if(window.devicePixelRatio >= 4)
        {
            this.load.image('android_msg', 'assets/android_ai_warning@4.png');
        ...
        {
            this.load.image('android_msg', 'assets/android_ai_warning@3.png');
        ...
        {
            this.load.image('android_msg', 'assets/android_ai_warning@2.png');
        ...
        {
            this.load.image('android_msg', 'assets/android_ai_warning.png');

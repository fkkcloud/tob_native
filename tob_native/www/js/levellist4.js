BasicGame.LevelList4 = function(game){};

BasicGame.LevelList4.prototype = {
	...
	createButtons: function(){
		...
		this.banner = this.game.add.sprite(this.game.world.width * (0.3333 + 0.3333 * 4 / 5), this.game.world.height * 0.9, 'nav_off');  
		this.banner.anchor.setTo(0.5, 0.5);	
	},
